...
export class LivingAppsService {
  ...
  static async createProjekteEntry(fields: CreateProjekte) {
    return callApi('POST', `/apps/${APP_IDS.PROJEKTE}/records`, { fields: cleanFieldsForApi(fields as any, 'projekte') });
  }
  static async updateProjekteEntry(id: string, fields: Partial<CreateProjekte>) {
    return callApi('PATCH', `/apps/${APP_IDS.PROJEKTE}/records/${id}`, { fields: cleanFieldsForApi(fields as any, 'projekte') });
  }
