...
interface AufgabenDialogProps {
  ...
  defaultValues?: Omit<Aufgaben['fields'], 'prioritaet' | 'aufgabe_status'> & {
...
export function AufgabenDialog({ open, onClose, onSubmit, defaultValues, recordId, projekteList, enablePhotoScan = true, enablePhotoLocation = true }: AufgabenDialogProps) {
  ...
  const DIALOG_INTENT = defaultValues ? 'Aufgaben bearbeiten' : 'Aufgaben hinzufügen';
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'aufgabe_status': (
      <div key="aufgabe_status" className="space-y-1.5">
        <Label htmlFor="aufgabe_status">Status <span className="text-destructive" aria-hidden="true">*</span></Label>
        <div role="radiogroup" className="flex flex-wrap gap-1.5">
          <button
            type="button"
            role="radio"
