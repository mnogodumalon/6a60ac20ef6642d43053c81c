...
const AUFGABEN_FIELDS = [
  { key: 'projekt', label: 'Projekt', type: 'applookup/select', targetEntity: 'projekte', targetAppId: 'PROJEKTE', displayField: 'projektname' },
  { key: 'titel', label: 'Aufgabentitel', type: 'string/text' },
  ...
  { key: 'aufgabe_status', label: 'Status', type: 'lookup/select', options: [{ key: 'offen', label: 'Offen' }, { key: 'in_bearbeitung', label: 'In Bearbeitung' }, { key: 'erledigt', label: 'Erledigt' }] },
  { key: 'zustaendig_vorname', label: 'Vorname', type: 'string/text' },
  { key: 'zustaendig_nachname', label: 'Nachname', type: 'string/text' },
];

const ENTITY_TABS = [
  { key: 'projekte', pascal: 'Projekte' },
  { key: 'aufgaben', pascal: 'Aufgaben' },
] as const;
...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<EntityKey>('projekte');
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'aufgaben' && fieldKey === 'projekt') {
  ...
  const getFieldMeta = useCallback((entity: EntityKey) => {
    const raw: any[] = (() => {
      switch (entity) {
        ...
        case 'aufgaben': return AUFGABEN_FIELDS as any[];
        default: return [];
      }
    })();
