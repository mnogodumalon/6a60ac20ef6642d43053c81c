...
export default function AufgabenDetailPage() {
  ...
  return (
    ...
    >
      <RecordHeader title={record.fields.titel ?? appLabel('aufgaben')} />
      ...
      <RecordSection title={t('details')} cols={2}>
        <RecordField label={fieldLabel('aufgaben', 'projekt')} value={getProjekteDisplayName(record.fields.projekt)} format="text" />
